package im.zego.advancedstreaming.streammonitoring;
...
public class StreamMonitoring extends AppCompatActivity {
    ...
    TextView publisherQualityLevelText;
    ...
    TextView playerQualityLevelText;
    ...
    public void bindView(){
        ...
        publisherQualityLevelText = findViewById(R.id.publisherQualityLevel);
        ...
        playerQualityLevelText = findViewById(R.id.qualityLevel);
    ...
    public void setEngineEventHandler(){
        engine.setEventHandler(new IZegoEventHandler() {
            ...
            public void onPublisherQualityUpdate(String streamID, ZegoPublishStreamQuality quality) {
                ...
                publisherQualityLevelText.setText(quality.level.toString());
            ...
            public void onPlayerQualityUpdate(String streamID, ZegoPlayStreamQuality quality) {
                ...
                playerLossText.setText(String.format("%.2f",quality.packetLostRate)+"%");
                playerQualityLevelText.setText(quality.level.toString());
