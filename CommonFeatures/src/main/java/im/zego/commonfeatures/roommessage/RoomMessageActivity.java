package im.zego.commonfeatures.roommessage;
                ...
                engine.sendBroadcastMessage(roomID, editBroadcastMessage.getText().toString(), new IZegoIMSendBroadcastMessageCallback() {
                    ...
                    public void onIMSendBroadcastMessageResult(int i, long l) {
                        if (i == 0){
                            ...
                            sendBroadcastButton.setText(ZegoViewUtil.GetEmojiStringByUnicode(ZegoViewUtil.checkEmoji)+getString(R.string.send_broadcastmessage));
                        } else {
                            sendBroadcastButton.setText(ZegoViewUtil.GetEmojiStringByUnicode(ZegoViewUtil.crossEmoji)+getString(R.string.send_broadcastmessage));
                        }
                    }
                });
                ...
                engine.sendBarrageMessage(roomID, editBarrageMessage.getText().toString(), new IZegoIMSendBarrageMessageCallback() {
                    ...
                    public void onIMSendBarrageMessageResult(int i, String s) {
                        if (i==0){
                            ...
                            sendBarrageButton.setText(ZegoViewUtil.GetEmojiStringByUnicode(ZegoViewUtil.checkEmoji)+getString(R.string.send_barragemessage));
                        } else {
                            sendBarrageButton.setText(ZegoViewUtil.GetEmojiStringByUnicode(ZegoViewUtil.crossEmoji)+getString(R.string.send_barragemessage));
                        }
                    }
                });
                    ...
                    engine.sendCustomCommand(roomID, editCustomCommand.getText().toString(), userList, new IZegoIMSendCustomCommandCallback() {
                        ...
                        public void onIMSendCustomCommandResult(int i) {
                            if (i == 0) {
                                ...
                                sendCustomCommandButton.setText(ZegoViewUtil.GetEmojiStringByUnicode(ZegoViewUtil.checkEmoji) + getString(R.string.send_customcommand));
                            } else {
                                sendCustomCommandButton.setText(ZegoViewUtil.GetEmojiStringByUnicode(ZegoViewUtil.crossEmoji) + getString(R.string.send_customcommand));
                            }
                        }
                    });
                ...
                engine.setRoomExtraInfo(roomID, "key", editRoomExtraInfo.getText().toString(), new IZegoRoomSetRoomExtraInfoCallback() {
                    ...
                    public void onRoomSetRoomExtraInfoResult(int i) {
                        if (i==0) {
                            ...
                            setRoomExtraInfoButton.setText(ZegoViewUtil.GetEmojiStringByUnicode(ZegoViewUtil.checkEmoji)+getString(R.string.set_roomextrainfo));
                        } else {
                            setRoomExtraInfoButton.setText(ZegoViewUtil.GetEmojiStringByUnicode(ZegoViewUtil.crossEmoji)+getString(R.string.set_roomextrainfo));
                        }
                    }
                });
