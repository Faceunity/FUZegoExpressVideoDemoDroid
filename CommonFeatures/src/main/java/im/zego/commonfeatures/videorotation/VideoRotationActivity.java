package im.zego.commonfeatures.videorotation;
            ...
            public void onPublisherStateUpdate(String streamID, ZegoPublisherState state, int errorCode, JSONObject extendedData) {
                ...
                if (isPublish) {
                    if (errorCode != 0 && state.equals(ZegoPublisherState.NO_PUBLISH)) {
                        if (isStart) {
                            startButton.setText(GetEmojiStringByUnicode(ZegoViewUtil.crossEmoji) + getString(R.string.stop_publishing));
                        }
                    } else {
                        if (isStart) {
                            startButton.setText(GetEmojiStringByUnicode(ZegoViewUtil.checkEmoji) + getString(R.string.stop_publishing));
                        }
                    }
                }
            }
            ...
            public void onPlayerStateUpdate(String streamID, ZegoPlayerState state, int errorCode, JSONObject extendedData) {
                ...
                if (!isPublish) {
                    if (errorCode != 0 && state.equals(ZegoPlayerState.NO_PLAY)) {
                        if (isStart) {
                            startButton.setText(GetEmojiStringByUnicode(ZegoViewUtil.crossEmoji) + getString(R.string.stop_playing));
                        }
                    } else {
                        if (isStart) {
                            startButton.setText(GetEmojiStringByUnicode(ZegoViewUtil.checkEmoji) + getString(R.string.stop_playing));
                        }
                    }
                }
            }
