        ...
        MixerMainActivity.engine.startAutoMixerTask(task, new IZegoMixerStartCallback() {
            ...
            public void onMixerStartResult(int errorCode, JSONObject var2) {
                ...
                if (errorCode != 0) {
                    ...
                    button_startAutoMixing.setText(ZegoViewUtil.GetEmojiStringByUnicode(ZegoViewUtil.crossEmoji)+getString(R.string.start_auto_stream_mixing));
                }
                else {
                    isMixing = true;
                    ...
                    button_startAutoMixing.setText(ZegoViewUtil.GetEmojiStringByUnicode(ZegoViewUtil.checkEmoji)+getString(R.string.stop_auto_stream_mixing));
                }
            }
        });
    }
        ...
        MixerMainActivity.engine.stopAutoMixerTask(currentMixTask, new IZegoMixerStopCallback() {
            ...
            public void onMixerStopResult(int i) {
                ...
                if (i != 0) {
                    ...
                    Toast.makeText(AutoMixerStartActivity.this, msg, Toast.LENGTH_SHORT).show();
                    button_startAutoMixing.setText(ZegoViewUtil.GetEmojiStringByUnicode(ZegoViewUtil.crossEmoji)+getString(R.string.stop_auto_stream_mixing));
                }
                else {
                    isMixing = false;
                    String msg = getString(R.string.tx_mixer_stop_ok);
                    Toast.makeText(AutoMixerStartActivity.this, msg, Toast.LENGTH_SHORT).show();
                    button_startAutoMixing.setText(ZegoViewUtil.GetEmojiStringByUnicode(ZegoViewUtil.checkEmoji)+getString(R.string.start_auto_stream_mixing));
                }
            }
        });
    }
