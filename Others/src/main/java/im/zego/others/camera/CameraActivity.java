...
public class CameraActivity extends AppCompatActivity {
    ...
    public void setCameraExposureCompensationSeekBarEvent() {
        exposureCompensationSeekBar.setProgress(10);
        exposureCompensationSeekBar.setMax(20);

        exposureCompensationSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                float value = (float)(progress - 10)/10;
    ...
    public void setEventHandler(){
        engine.setEventHandler(new IZegoEventHandler() {
            ...
            public void onPublisherCapturedVideoFirstFrame(ZegoPublishChannel channel) {
                ...
                if (isSupported) {
                    supportFocusState.setText("Support Focus: " + ZegoViewUtil.GetEmojiStringByUnicode(ZegoViewUtil.blueCircleEmoji));
                } else {
                    supportFocusState.setText("Support Focus: " + ZegoViewUtil.GetEmojiStringByUnicode(ZegoViewUtil.redCircleEmoji));
                }
            }
        });
    }
