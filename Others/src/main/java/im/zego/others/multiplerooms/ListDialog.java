...
//        }
        ...
        public void setUserListString(HashMap<String, ZegoUser> content){
            listContentString.clear();
            for (ZegoUser user: content.values()){
                listContentString.add("UserName:"+user.userName+"  UserID:"+user.userID);
            }
        }
        public void setStreamListString(HashMap<String, ZegoStream> content){//, boolean isPublish
            listContentString.clear();
...
//            }
            for (ZegoStream stream: content.values()){
