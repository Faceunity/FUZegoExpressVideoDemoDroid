package im.zego.others.security;
...
public class SecurityActivity extends AppCompatActivity {
    ...
    EditText publishEncryptionKeyEdit;
    EditText playDecryptionKeyEdit;
    Button setPublishStreamEncryptionButton;
    Button setPlayStreamDecryptionButton;
    TextView roomState;
    ...
    //show info
    TextView encryptPublishNotice;
    TextView encryptPlayNotice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setPublishEncryptionButtonEvent();
        setPlayStreamDecryptionButtonEvent();
        setEventHandler();
        setApiCalledResult();
        showInfo();
    }
    public void bindView(){
        ...
        publishEncryptionKeyEdit = findViewById(R.id.publishEncryptionKeyEdit);
        playDecryptionKeyEdit = findViewById(R.id.playDecryptionKeyEdit);
        setPlayStreamDecryptionButton = findViewById(R.id.setPlayStreamEncryptionKeyButton);
        setPublishStreamEncryptionButton = findViewById(R.id.setPublishStreamEncryptionKeyButton);
        roomState = findViewById(R.id.roomState);
        encryptPlayNotice = findViewById(R.id.EncryptPlayNotic);
        encryptPublishNotice = findViewById(R.id.EncryptPublishNotice);
    }
    public void setDefaultValue(){
        roomID = "0032";
        publishStreamID = "0032";
        playStreamID = "0032";
        ...
        startPublishingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isPublish) {
                    ...
                    publishEncryptionKeyEdit.setText("");
                }
            }
        });
    }
        ...
        startPlayingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isPlay){
                    ...
                    playDecryptionKeyEdit.setText("");
                }
            }
        });
    }
    public void setPublishEncryptionButtonEvent(){
        setPublishStreamEncryptionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String key = publishEncryptionKeyEdit.getText().toString();
                engine.setPublishStreamEncryptionKey(key);
                AppLogger.getInstance().callApi("Set Publish Stream Encryption Key:%s", key);
            }
        });
    }
    public void setPlayStreamDecryptionButtonEvent(){
        setPlayStreamDecryptionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String key = playDecryptionKeyEdit.getText().toString();
                engine.setPlayStreamDecryptionKey(playStreamID,key);
                AppLogger.getInstance().callApi("Set Play Stream Encryption Key:%s", key);
            }
        });
    }
    ...
    public void showInfo(){
        //show info tell users what meaning of the words
        View.OnClickListener listener = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(view.getId() == R.id.EncryptPlayNotic){
                    Toast.makeText(getApplicationContext(),R.string.EncryptPlayNotice,Toast.LENGTH_LONG).show();
                    return;
                }
                if(view.getId() == R.id.EncryptPublishNotice){
                    Toast.makeText(getApplicationContext(),R.string.EncryptPublishNotice,Toast.LENGTH_LONG).show();
                    return;
                }
            }
        };
        encryptPublishNotice.setOnClickListener(listener);
        encryptPlayNotice.setOnClickListener(listener);
    }
    @Override
