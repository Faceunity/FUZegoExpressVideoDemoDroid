...
public class CustomAudioCaptureAndRenderingLoginActivity extends AppCompatActivity {
    ...
    public void bindView(){
        ...
        audioFrameTypeSpinner = findViewById(R.id.spinnerAudioFrameType);
    }
    ...
    public void setStartButton(){
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("customAudioFrameType", audioFrameTypeSpinner.getSelectedItemPosition());
