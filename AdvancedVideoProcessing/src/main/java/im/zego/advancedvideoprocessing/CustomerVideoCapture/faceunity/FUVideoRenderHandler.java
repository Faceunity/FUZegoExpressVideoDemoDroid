...
import im.zego.commontools.videorender.AVCDecoder;
import im.zego.commontools.videorender.MyVideoFrame;
import im.zego.commontools.videorender.PixelBuffer;
import im.zego.commontools.videorender.Renderer;
...
//    MyVideoFrame videoPlayFrame = new MyVideoFrame();
    ...
    private Boolean useFaceunity = true;
    ...
    public void onCapturedVideoFrameRawData(ByteBuffer[] data, int[] dataLength, ZegoVideoFrameParam param, ZegoVideoFlipMode flipMode, ZegoPublishChannel channel) {
        ...
        if (!useFaceunity) {
            ...
            videoPlayFrame.byteBuffers = mOutputBuffer;
        }
    ...
    public void onRemoteVideoFrameRawData(ByteBuffer[] data, int[] dataLength, ZegoVideoFrameParam param, String streamID) {
        ...
        if (!useFaceunity) {
            ...
            data[0].flip();
            videoPlayFrame1.byteBuffers = data;
        }
