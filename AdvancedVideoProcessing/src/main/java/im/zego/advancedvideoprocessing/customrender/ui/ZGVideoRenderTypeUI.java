...
import im.zego.advancedvideoprocessing.CustomerVideoCapture.faceunity.FUVideoRenderPublish;
...
public class ZGVideoRenderTypeUI extends AppCompatActivity {
    ...
    public void setUI() {
        ...
        startFaceunity = findViewById(R.id.start_faceunity);
    ...
    public void setStartButton() {
        ...
        startFaceunity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent temp = new Intent(ZGVideoRenderTypeUI.this, FUVideoRenderPublish.class);
                temp.putExtra("isRGB", isRGB);
                temp.putExtra("isRawData", isRawData);
                temp.putExtra("roomID", editRoomID.getText().toString());
                temp.putExtra("playStreamID", editPlayStreamID.getText().toString());
