package im.zego.videocapture.aveencoder;
...
public class AVCEncoder {
        ...
        if (codecInfo != null) {
            ...
            for (int i = 0; i < capabilities.colorFormats.length && colorFormat == 0; i++) {
                ...
                switch (format) {
                    ...
                    case MediaCodecInfo.CodecCapabilities.COLOR_QCOM_FormatYUV420SemiPlanar:    /*I420 --- YUV4:2:0 --- Nvidia Tegra 3, Samsu */
                        colorFormat = format;
                        break;
                    default:
                        Log.d("Zego", " AVCEncoder unsupported color format " + format);
    ...
    public AVCEncoder(int viewwidth, int viewheight) {
        ...
        mMediaFormat.setInteger(MediaFormat.KEY_FRAME_RATE, 10);
